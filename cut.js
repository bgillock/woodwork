...
function renderCut() {
    ...
    //   var lenSlider = document.getElementById('backgroundShiftRight-handle')
    //   lenSlider.innerHTML = '<div class="ui-slider-range ui-widget-header ui-corner-all ui-slider-range-max" style="width: 22%;"></div>'
